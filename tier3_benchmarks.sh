#!/bin/bash
# ============================================================================
# Tier 3 Multi-Model Benchmark Suite (27-32B Parameters)
# ============================================================================
# Usage:
#   cd ~/ollama/llm-infrence-benchmark-tests
#   source venv/bin/activate
#   bash tier3_benchmark.sh
#
# Options:
...
# Tier 3 models: 27-32B parameter range
# Format: "ollama_name:tag|display_name|param_count|architecture"
MODELS=(
    "gemma2:27b|Gemma2-27B|27B|Dense-Transformer"
    "qwen2.5:32b|Qwen2.5-32B|32B|Dense-Transformer"
    "deepseek-r1:32b|DeepSeek-R1-32B|32B|Dense-Transformer-CoT"
)
...
# --- Main Script ---
log_header "TIER 3 MULTI-MODEL BENCHMARK SUITE (27-32B)"
echo ""
