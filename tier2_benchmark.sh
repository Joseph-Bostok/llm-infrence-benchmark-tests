#!/bin/bash
# ============================================================================
# Tier 2 Multi-Model Benchmark Suite (13-14B Parameters)
# ============================================================================
# Usage:
#   cd ~/ollama/llm-infrence-benchmark-tests
#   source venv/bin/activate
#   bash tier2_benchmark.sh
#
# Options:
...
# Tier 2 models: 13-14B parameter range
# Format: "ollama_name:tag|display_name|param_count|architecture"
MODELS=(
    "qwen2.5:14b|Qwen2.5-14B|14B|Dense-Transformer"
    "phi4:14b|Phi4-14B|14B|Dense-Transformer"
    "deepseek-r1:14b|DeepSeek-R1-14B|14B|Dense-Transformer-CoT"
)
...
# --- Main Script ---
log_header "TIER 2 MULTI-MODEL BENCHMARK SUITE (13-14B)"
echo ""
